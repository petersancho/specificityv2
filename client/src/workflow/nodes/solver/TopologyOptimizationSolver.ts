...
export const TopologyOptimizationSolverNode: WorkflowNodeDefinition = {
  ...
  parameters: [
    ...
    },
    {
      ...
      max: 100,
      step: 1,
      description: "Grid resolution in Z (1 for 2D, 30-100 for 3D, lower = faster).",
    },
    {
      key: "volFrac",
    ...
    },
    {
      ...
      max: 100,
      step: 5,
      description: "Minimum iterations before convergence check.",
    },
    {
      key: "tolChange",
    ...
    },
    {
      ...
      max: 0.2,
      step: 0.01,
      description: "Maximum gray level for convergence (lower = more binary 0/1 design).",
    },
    {
      key: "betaMax",
      label: "Beta Max",
    ...
    },
    {
      ...
      max: 0.5,
      step: 0.01,
      description: "Penalty increment per continuation step (0.10 recommended for balanced convergence).",
    },
    {
      key: "betaMultiplier",
      ...
      max: 2.0,
      step: 0.01,
      description: "Beta multiplier per continuation step (1.2 recommended for balanced convergence).",
    },
    {
      key: "enableRollback",
    ...
    },
    {
      ...
      max: 0.02,
      step: 0.0001,
      description: "Relative change threshold for stability detection (0.005 = 0.5% change).",
    },
    {
      key: "seed",
      label: "Random Seed",
