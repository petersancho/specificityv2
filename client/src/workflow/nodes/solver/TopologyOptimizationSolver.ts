...
export const TopologyOptimizationSolverNode: WorkflowNodeDefinition = {
  ...
  parameters: [
    ...
    },
    {
      ...
      max: 500,
      step: 10,
      description: "Minimum iterations before convergence check (80+ recommended for quality results).",
    },
    {
      key: "tolChange",
    ...
    },
    {
      ...
      max: 0.9,
      step: 0.05,
      description: "Isosurface cutoff for marching cubes (0.35 = more geometry visible, 0.5+ = only high-density regions).",
    },
    {
      key: "grayTol",
