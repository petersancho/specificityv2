...
export const TopologyOptimizationSolverNode: WorkflowNodeDefinition = {
  ...
  parameters: [
    ...
    },
    {
      ...
      max: 0.5,
      step: 0.01,
      description: "Penalty increment per continuation step (0.05 recommended for smooth convergence).",
    },
    {
      key: "betaMultiplier",
      ...
      max: 2.0,
      step: 0.01,
      description: "Beta multiplier per continuation step (1.1 recommended for smooth convergence).",
    },
    {
      key: "enableRollback",
    ...
    },
    {
      ...
      max: 0.02,
      step: 0.0001,
      description: "Relative change threshold for stability detection (0.003 = 0.3% change).",
    },
    {
      key: "seed",
      label: "Random Seed",
