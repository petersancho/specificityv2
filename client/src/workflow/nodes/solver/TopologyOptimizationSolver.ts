...
export const TopologyOptimizationSolverNode: WorkflowNodeDefinition = {
  ...
  parameters: [
    ...
    },
    {
      ...
      max: 0.5,
      step: 0.01,
      description: "Penalty increment per continuation step (0.03 recommended for smooth convergence).",
    },
    {
      key: "betaMultiplier",
      ...
      max: 2.0,
      step: 0.01,
      description: "Beta multiplier per continuation step (1.05 recommended for smooth convergence).",
    },
    {
      key: "enableRollback",
