...
export const TopologyOptimizationSolverNode: WorkflowNodeDefinition = {
  ...
  parameters: [
    ...
    },
    {
      ...
      max: 0.3,
      step: 0.01,
      description: "Max density change per iteration (0.2 is standard, lower = slower convergence, higher = less stable).",
    },
    {
      key: "maxIters",
    ...
    },
    {
      ...
      max: 100,
      step: 5,
      description: "Minimum iterations before convergence check (0 = check immediately, 30+ recommended for penalty/projection continuation).",
    },
    {
      key: "tolChange",
    ...
    },
    {
      ...
      max: 512,
      step: 16,
      description: "Maximum Heaviside projection sharpness (higher = sharper 0/1 transition).",
    },
    {
      key: "seed",
      label: "Random Seed",
