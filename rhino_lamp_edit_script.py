...
PARAMS = {
    ...
    "triangle_side": 98.0,
    "vase_height": 88.0,
    "vase_base_radius": 48.0,
    "vase_mid_radius": 68.0,
    "vase_neck_radius": 28.0,
    # Twisted base (faceted loft)
    "twist_height": 72.0,
    "twist_radius": 42.0,
    "twist_top_scale": 0.75,
    "twist_sides": 8,
    "twist_layers": 9,
    "twist_rotation": 110.0,
    # Spiral wave base (smooth wave loft)
    "spiral_height": 75.0,
    "spiral_radius": 45.0,
    "spiral_top_scale": 0.7,
    "spiral_waves": 7,
    "spiral_wave_amp": 0.2,
    "spiral_layers": 12,
    "spiral_twist": 190.0,
    ...
    # Shade
    "shade_height": 135.0,
    "shade_outer_radius": 62.0,
    "shade_wall": 2.8,
    "sleeve_height": 16.0,  # must be >= neck_height
    "shade_pattern": "weave",  # "moire", "weave", "lattice", "slots", or "none"
    ...
    "slot_margin": 14.0,
    "slot_variation": 0.35,
    "slot_wave_frequency": 2.6,
    # Lattice pattern (subdivision effect)
    "lattice_rows": 7,
    "lattice_columns": 36,
    "lattice_window_width": 7.0,
    "lattice_window_height": 16.0,
    "lattice_window_depth": 10.0,
    "lattice_margin": 14.0,
    "lattice_offset_ratio": 0.4,
    "lattice_twist_degrees": 12.0,
    # Helical weave pattern
    "weave_strand_count": 9,
    "weave_turns": 1.6,
    "weave_pipe_radius": 3.0,
    "weave_steps": 72,
    "weave_margin": 12.0,
    # Moire pattern (multi-helix + ring bands)
    "moire_strand_count": 12,
    "moire_turns_primary": 1.8,
    "moire_turns_secondary": 2.8,
    "moire_pipe_radius": 2.4,
    "moire_steps": 90,
    "moire_rings": 8,
    "moire_ring_radius": 2.3,
    "moire_margin": 10.0,
    # Central port
    "cord_diameter": 7.5,
    "bulb_diameter": 30.0,
